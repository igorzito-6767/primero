...
Zotero_Preferences.Components.ProxySettings = class ProxySettings extends React.Component {
  ...
  render() {
    ...
    }, "proxy documentation"), " for more information."), React.createElement(Zotero_Preferences.Components.ProxyPreferences, {
  ...
  render() {
    ...
    if (this.state.loopPreventionTimestamp > Date.now() && this.state.transparent) {
      redirectLoopPrevention = React.createElement("div", {
        ...
        value: "Re-enable proxy redirection"
      }));
    }
    ...
    }), "\xA0Show a notification when redirecting through a proxy"), React.createElement("br", null), autoRecognise, React.createElement("p", null, React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      disabled: !this.state.transparent,
      onChange: this.handleCheckboxChange,
      name: "disableByDomain",
      defaultChecked: this.state.disableByDomain
    }), "\xA0Disable proxy redirection when my domain name contains (available when Zotero is running)"), React.createElement("br", null), React.createElement("input", {
      style: {
        marginTop: "0.5em",
        marginLeft: "1.5em"
      },
...
Zotero_Preferences.Components.ProxyDetails = function ProxyDetails(props) {
  ...
  function _renderOpenAthensInput() {
    ...
    }, "OpenAthens Redirector Domain:"), React.createElement("input", {
  ...
  }), "URL-rewriting proxy (e.g., EZproxy)"), React.createElement("label", null, React.createElement("input", {
    type: "radio",
    name: "proxyType",
    value: "openathens",
    checked: isOpenAthens,
    onChange: handleTypeChange
  }), "OpenAthens")), multiHost && !isOpenAthens && React.createElement("p", null, React.createElement("label", null, React.createElement("input", {
    type: "checkbox",
    name: "autoAssociate",
    onChange: handleCheckboxChange,
    checked: autoAssociate
  }), "\xA0Automatically associate new hosts")), isOpenAthens ? _renderOpenAthensInput() : _renderProxyInput(), error && React.createElement("p", {
    style: {
      color: "red"
    }
  ...
  }, React.createElement("label", null, "Hostname:", React.createElement("input", {
    style: {
      flexGrow: '1'
    },
    type: "text",
